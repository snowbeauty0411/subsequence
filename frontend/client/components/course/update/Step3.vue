      ...
      ><b-row
        ><b-col cols="12" xl="6" class="g-0"
          ...
          >
            ...
            <div class="editService-step6-footer w-full">
              <div
                class="text-danger"
                    ...
                    <div class="flex flex-col">
                      ...
                      <div class="coursePrice flex justify-end items-baseline">
                        ...
                        /<span class="text-[18px]">
                          {{
                            this.detailCourse.cycle_format === ""
                              ? "月"
                              : this.detailCourse.cycle_format
                          }}</span
                        >
...
export default {
  ...
  created() {
    ...
    this.cycle = this.detailCourse.cycle;
    ...
    let typeServiceId = localStorage.getItem("typeServiceId");
