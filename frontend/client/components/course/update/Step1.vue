        ...
        ><b-col cols="12" xl="6" class="g-0"
          ...
          >
            <div class="editService-step4-left-form">
              ...
              <div class="step-title mt-5">画像を追加しましょう。</div>
            ...
            <div class="editService-step4-footer w-full">
              <div class="editService-step4-left-btn flex">
                <b-button
                  class="
                    btn-return
                    flex
...
export default {
  ...
  created() {
    ...
    if (isReloadPage === "true") {
      this.$router.push(`/seller/service/${this.hashID}/edit`);
    }
    this.index = Number(this.$route.query.index);
    let courseDetail = localStorage.getItem("detailCourse");
    this.detailCourse = JSON.parse(courseDetail);
    let listCourseNew = JSON.parse(localStorage.getItem("listCourseNew"));
    ...
    if (this.detailCourse.isUpdate === false && this.store.imgCourseEdit.length > 0) {
      ...
      this.url = this.detailCourse.course_images !== "" ? this.detailCourse.course_images : null
    }
  },
  ...
  methods: {
    ...
    async nextStep() {
      ...
      if (!result) {
        ...
        if (this.url == null) {
          ...
          this.$router.push("/seller/service/service-course/update?step=2");
        }
      }
    },
    ...
    backStep() {
      ...
      this.$router.push(`/seller/service/${idService}/edit`);
    },
