  ...
  methods: {
    ...
    nextStep() {
      ...
      if (this.selected === "0") {
        ...
        this.$router.push("/seller/service/service-course-draft/update?step=6");
      } else {
        if (this.age_confirm === null || this.age_confirm === "") {
          ...
          if (!this.isNotFullWidth) {
            ...
            this.$router.push(
              "/seller/service/service-course-draft/update?step=6"
            );
          }
        }
      }
    ...
    backStep() {
      this.$router.push("/seller/service/service-course-draft/update?step=4");
    },
  },
};
</script>
