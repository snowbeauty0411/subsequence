                    ...
                    <div class="flex flex-col">
                      ...
                      <div class="coursePrice flex justify-end items-baseline">
                        ...
                        /<span class="text-[18px]">
                          {{ cycle === 1 ? "月" : this.cycleFormat }}</span
                        >
                      </div>
                      <div
                        class="
...
export default {
  ...
  created() {
    ...
    if (this.listCourse[this.index].price === 0) {
      this.price = null;
    } else {
      this.price = this.listCourse[this.index].price;
    }
    ...
    let type4 = localStorage.getItem("data-step-4");
    if (type4 != null) {
      if (Number(type4) == 1) {
  ...
  watch: {
    price() {
      if (this.price != "" && this.price != null) {
        ...
        if (found) {
          ...
          this.listCourse[this.index].price = this.coursePrice;
    ...
    cycle() {
      ...
      this.listCourse[this.index].cycle_format = this.filterCycle(this.cycle);
      this.cycleFormat = this.filterCycle(this.cycle);
      this.listCourse[this.index].cycle = this.cycle;
      localStorage.setItem("list-course", JSON.stringify(this.listCourse));
    },
  },
  ...
  methods: {
    ...
    backStep() {
      const hash_id = this.$route.query.hash_id;
      this.$router.push(
        `/seller/service/service-course-draft/create?step=2&index=${this.index}&hash_id=${hash_id}`
      );
    },
  },
};
