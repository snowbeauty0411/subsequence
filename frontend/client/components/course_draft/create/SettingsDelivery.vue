<template>
  <div class="editService-step1 relative">
    <div class="editService-headerBox absolute flex items-center">
      ...
      <div class="d-flex">
        <div class="headerText mx-2">定期便タイプ</div>
        <span class="ml-5">※あとから編集不可</span>
      </div>
    </div>
    <b-container fluid
      ><b-row
        ><b-col cols="12" lg="6" class="g-0"
          ><div class="editService-step1-left flex flex-col justify-between">
            ...
            <div class="editService-step1-left-form my-1">
              ...
              <div class="step1-form relative">
                <div class="step1-form-data">
                  <b-form-radio-group
                    ...
                    :options="option2s"
                    stacked
                    class="w-full form-raido-custom form-custom-2"
                  ></b-form-radio-group>
                </div>
                <div
                  class="descriptionYellow absolute flex flex-col"
            ...
            <div class="editService-step1-left-btn flex">
              <b-button
                class="
                  btn-return
                  flex
