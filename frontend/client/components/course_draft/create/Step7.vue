    ...
    <b-container fluid
      ><b-row
        ><b-col cols="12" xl="6" class="g-0"
          ><div
            class="editService-step7-course-left flex flex-col justify-between"
          >
            ...
            <div
              ...
              "
            >
              <div class="editService-step7-course-left-btn flex">
                <b-button
                  class="
                    btn-return
                    flex
          ...
          if (lastItem.name !== "") {
            for (let i = 0; i < this.listCourse.length; i++) {
              if (this.index !== this.listCourse[i].index) {
                ...
                // this.store.listImgCourse.splice(this.index, 1);
              }
            }
            let listCourseData = {
              index: this.index + 1,
