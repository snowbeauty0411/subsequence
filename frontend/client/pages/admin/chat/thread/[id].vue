    ...
    <div class="threadChatId-content">
      <div class="threadChatId-content-top">
        <div class="threadChatId-content-top-left flex items-center">
          ...
          <div class="item-name">{{ partner.partner_name }}</div>
        </div>
      </div>
      <div
        v-if="preloadList"
...
export default {
  ...
  watch: {
    ...
    listMessagesAdmin() {
      this.preload = true;
      this.messages = this.listMessagesAdmin.messages;
      this.partner = this.listMessagesAdmin.partner_info;
  ...
  methods: {
    ...
    getListMessages() {
      const dataForm = {
        thread_id: this.id_thread,
        keyword: this.keyword,
      };
      this.store.getListMessagesAdmin(dataForm);
    },
